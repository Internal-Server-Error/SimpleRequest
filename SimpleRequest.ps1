...
$Go.height = 20
$Go.Anchor = 'top,right'
$Go.location = New-Object System.Drawing.Point(736, 18)
...
$Method.Font = 'Microsoft Sans Serif,10'
...
$Header1.location = New-Object System.Drawing.Point(7, 43)
$Header1.Font = 'Microsoft Sans Serif,10'
...
$Header2.location = New-Object System.Drawing.Point(7, 66)
...
$Header3.location = New-Object System.Drawing.Point(8, 89)
$Header3.Font = 'Microsoft Sans Serif,10'
...
$Header4.location = New-Object System.Drawing.Point(7, 112)
$Header4.Font = 'Microsoft Sans Serif,10'
...
$Body.location = New-Object System.Drawing.Point(9, 140)
$Body.Font = 'Microsoft Sans Serif,10'
...
$Go.Add_Click( { })
$Method.Add_SelectedValueChanged( { })

$SimpleRequest.ShowDialog();

function ExecuteRequest($url, $method, $body, $headers) {
   return Invoke-WebRequest -UseBasicParsing $url -Method $method -Body $body -Headers $headers; 
}
